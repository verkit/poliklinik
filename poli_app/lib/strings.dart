...
List<PolyclinicModel> poliklinik = [
  PolyclinicModel(
    ...
    gambar: 'https://firebasestorage.googleapis.com/v0/b/rsd-balung.appspot.com/o/poliklinik%2Fklinik%20kandungan.png?alt=media&token=c87c250c-b438-4b24-9ca2-5d4ecbd20d8c',
  ),
  PolyclinicModel(
    nama: 'Poliklinik Anak',
    gambar: 'https://firebasestorage.googleapis.com/v0/b/rsd-balung.appspot.com/o/poliklinik%2Fklinik%20anak.jpg?alt=media&token=9a42fcba-2c99-4c41-b409-b34a23f4e69a',
  ),
  PolyclinicModel(
    nama: 'Poliklinik Bedah',
    gambar: 'https://firebasestorage.googleapis.com/v0/b/rsd-balung.appspot.com/o/poliklinik%2Fklinik%20bedah.jpg?alt=media&token=964fb39b-8fdc-4ed5-9af8-bfa5b1e2db0a',
  ),
  PolyclinicModel(
    nama: 'Poliklinik Gigi',
    gambar: 'https://firebasestorage.googleapis.com/v0/b/rsd-balung.appspot.com/o/poliklinik%2Fklinik%20gigi%20dan%20mulut.png?alt=media&token=80daa5c6-234e-42e3-8181-7ccb83b8925c',
  ),
  PolyclinicModel(
    nama: 'Poliklinik Penyakit Dalam',
    gambar: 'https://firebasestorage.googleapis.com/v0/b/rsd-balung.appspot.com/o/poliklinik%2Fklinik%20penyakit%20dalam.png?alt=media&token=84ba3520-151a-42df-8afc-3339bbffd9d1',
  ),
  PolyclinicModel(
    nama: 'Poliklinik THT',
    gambar: 'https://firebasestorage.googleapis.com/v0/b/rsd-balung.appspot.com/o/poliklinik%2Fklinik%20tht.jpg?alt=media&token=e065238e-8a2b-4026-95a9-11ce664f4eff',
  ),
  PolyclinicModel(
    nama: 'Poliklinik Mata',
    gambar: 'https://firebasestorage.googleapis.com/v0/b/rsd-balung.appspot.com/o/poliklinik%2Fklinik%20mata.jpg?alt=media&token=90765172-d358-47df-bf8b-f7458c9fc28b',
  ),
  PolyclinicModel(
    nama: 'Poliklinik Radiologi',
    gambar: 'https://firebasestorage.googleapis.com/v0/b/rsd-balung.appspot.com/o/poliklinik%2Fklinik%20jantung.jpg?alt=media&token=86cf0475-ecd8-4a57-b89c-1045404d736a',
  ),
  PolyclinicModel(
    nama: 'Poliklinik Patologi',
    gambar: 'https://firebasestorage.googleapis.com/v0/b/rsd-balung.appspot.com/o/poliklinik%2Fklinik%20umum.jpg?alt=media&token=191da0f1-fb55-4cbb-b3c2-c86e1e210e09',
  ),
  PolyclinicModel(
    nama: 'Poliklinik Anastesi',
    gambar: 'https://firebasestorage.googleapis.com/v0/b/rsd-balung.appspot.com/o/poliklinik%2Fklinik%20vct.jpg?alt=media&token=43cc558b-76d3-40a6-82ac-d29f5f855b1d',
  ),
  PolyclinicModel(
    nama: 'Poliklinik Orthopedi',
    gambar: 'https://firebasestorage.googleapis.com/v0/b/rsd-balung.appspot.com/o/poliklinik%2Fklinik%20nyeri.jpg?alt=media&token=03000014-0f1a-441c-a954-7547ed7b49d2',
  ),
];
